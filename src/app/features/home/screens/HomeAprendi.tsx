    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <TouchableOpacity
          ...
          onPress={() => router.push("/features/home/screens/chat")}
          activeOpacity={0.85}
        >
        ...
        <TouchableOpacity
          style={styles.optionCard}
          onPress={() => router.push("/features/home/screens/Pruebas")}
          activeOpacity={0.85}
        >
      ...
      <View style={styles.navbar}>
        <TouchableOpacity style={styles.navItem}>
          <Ionicons name="home" size={22} color="#5b8cdb" />
          <Text style={[styles.navLabel, { color: "#5b8cdb" }]}>Inicio</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.navItem}>
